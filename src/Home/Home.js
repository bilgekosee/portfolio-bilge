      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4  pt-40  ">
        ...
        <div className="sm:ml-10 xs:ml-10">
          ...
          <p className="text-gray-600 mt-4">
            ...
            using modern technologies. With expertise in React, Vue, Tailwind
            CSS and JavaScript, I strive to write clean, efficient code and
            deliver high-quality results for every project.
          </p>
          <div className="mt-10">
            <a
              href="#contact"
